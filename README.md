...
If you don't have flask on your computer, please install it using pip install Flask command. You can run the code with the command $python server.py. Once you run it, you can type in http://127.0.0.1:5000/ on your browser to see the webpage rendered locally.
